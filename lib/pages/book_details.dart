...
import 'package:lib_management/pages/book_add.dart';
import 'package:lib_management/pages/style.dart';
import 'package:lib_management/pages/colors.dart';
import 'package:lib_management/pages/book_cover.dart';
import 'package:flutter/material.dart';
// import 'package:flutter_speed_dial/flutter_speed_dial.dart';
import 'package:provider/provider.dart';
import 'package:lib_management/pages/books.dart';
import 'package:lib_management/pages/book_notifier.dart';
import 'package:lib_management/pages/star_rating.dart';
...
class BookDetails extends StatelessWidget {
  ...
  SpeedDial({required double overlayOpacity, required Color overlayColor, required AnimatedIconData animatedIcon, List<SpeedDialChild> children}) {}
}
